...
type Trip struct {
	...
	SatrtPos      *Location   `protobuf:"bytes,5,opt,name=satrt_pos,json=satrtPos,proto3" json:"satrt_pos,omitempty"`
...
func (x *Trip) GetSatrtPos() *Location {
	if x != nil {
		return x.SatrtPos
	}
	return nil
...
var file_trip_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x07, 0x66, 0x65, 0x65, 0x43, 0x65, 0x6e, 0x74, 0x12, 0x2e, 0x0a, 0x09, 0x73, 0x61,
	0x74, 0x72, 0x74, 0x5f, 0x70, 0x6f, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e,
	0x63, 0x6f, 0x6f, 0x6c, 0x63, 0x61, 0x72, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x52, 0x08, 0x73, 0x61, 0x74, 0x72, 0x74, 0x50, 0x6f, 0x73, 0x12, 0x2a, 0x0a, 0x07, 0x65, 0x6e,
...
var file_trip_proto_depIdxs = []int32{
	1, // 0: coolcar.Trip.satrt_pos:type_name -> coolcar.Location
