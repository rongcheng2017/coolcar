...
func (imp *impersonation) GetRequestMetadata(ctx context.Context, uri ...string) (map[string]string, error) {
	return map[string]string{
		auth.ImpersonateAccountHeader: imp.AccountID.String(),
	}, nil
}

func (imp *impersonation) RequireTransportSecurity() bool {
	return false
}
