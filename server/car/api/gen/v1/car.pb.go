...
type Driver struct {
	...
	Id        string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	AvatorUrl string `protobuf:"bytes,2,opt,name=avator_url,json=avatorUrl,proto3" json:"avator_url,omitempty"`
}
...
func (x *Driver) GetAvatorUrl() string {
	if x != nil {
		return x.AvatorUrl
	}
	return ""
...
var file_car_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x72, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x61,
	0x76, 0x61, 0x74, 0x6f, 0x72, 0x55, 0x72, 0x6c, 0x22, 0x44, 0x0a, 0x08, 0x4c, 0x6f, 0x63, 0x61,
