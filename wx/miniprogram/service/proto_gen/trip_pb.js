...
export const coolcar = $root.coolcar = (() => {
    ...
    coolcar.Trip = (function() {
         ...
         * @property {coolcar.ILocation|null} [satrtPos] Trip satrtPos
        ...
        /**
         * Trip satrtPos.
         * @member {coolcar.ILocation|null|undefined} satrtPos
         * @memberof coolcar.Trip
         * @instance
         */
        Trip.prototype.satrtPos = null;
        ...
        Trip.fromObject = function fromObject(object) {
            ...
            if (object.satrtPos != null) {
                if (typeof object.satrtPos !== "object")
                    throw TypeError(".coolcar.Trip.satrtPos: object expected");
                message.satrtPos = $root.coolcar.Location.fromObject(object.satrtPos);
            }
        ...
        Trip.toObject = function toObject(message, options) {
            ...
            if (message.satrtPos != null && message.hasOwnProperty("satrtPos"))
                object.satrtPos = $root.coolcar.Location.toObject(message.satrtPos, options);
